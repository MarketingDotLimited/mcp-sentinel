...
describe('broker final branches 3', async () => {
  ...
  it('covers remaining branches (304, 511, 739, 396)', async (t) => {
    ...
    try {
      await handleRequest({ operation: 'broker.health', parameters: {}, requestId: '00000000-0000-0000-0000-000000000000' });
    } catch (e) {
    ...
    try {
      await handleRequest({ operation: 'config.apply', parameters: { configId: 'test-config-4', content: 'xyz' }, requestId: '00000000-0000-0000-0000-000000000000' });
    } catch (e) {
    ...
    db.exec(`INSERT INTO projects (id, payload) VALUES ('00000000-0000-4000-8000-000000000001', '{"id":"00000000-0000-4000-8000-000000000001","rootPath":"/tmp/test-project-1","repoPath":"/tmp/test-project-1","runAsUser":"testuser"}') ON CONFLICT DO NOTHING;`);
    ...
    const cp = import.meta.resolve ? (await import('node:module')).createRequire(import.meta.url)('node:child_process') : require('node:child_process');
    ...
    try {
      await handleRequest({ operation: 'project.git', parameters: { projectId: '00000000-0000-4000-8000-000000000002', action: 'pull', args: {} }, requestId: '00000000-0000-0000-0000-000000000000' });
    } catch (e) {
    ...
    try {
      await handleRequest({ operation: 'project.git', parameters: { projectId: '00000000-0000-4000-8000-000000000002', action: 'pull', args: {} }, requestId: '00000000-0000-4000-8000-000000000000' });
    } catch (e) {
