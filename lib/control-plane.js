...
const WORKFLOWS = [
  ...
  },
  {
    ...
    description: 'Guides an AI through repository setup, tests, a deployment plan, health checks, and recovery planning.',
    risk: 'approval-required',
    prompts: ['Inspect the project', 'Run tests', 'Prepare a deployment plan', 'Ask for approval before any direct deployment'],
  },
];
...
export function getDeploymentPlan(project) {
  const steps = [
    ...
    { stage: 'Recover', action: 'If validation fails, stop and document the exact revision and recovery procedure. Do not claim an automatic rollback is available.', tool: 'manual-recovery' },
  ];
